...
const styles = StyleSheet.create({
  ...
  statusBanner: { minHeight: 78, borderRadius: 8, borderWidth: 1, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 13 }, statusOnline: { backgroundColor: BudgetColors.greenSoft, borderColor: '#C6DCCA' }, statusOffline: { backgroundColor: BudgetColors.coralSoft, borderColor: '#EDC6B9' }, statusChecking: { backgroundColor: BudgetColors.blueSoft, borderColor: '#C8DCE6' },
