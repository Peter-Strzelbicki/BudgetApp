...
const styles = StyleSheet.create({
  ...
  warningPanel: { borderColor: BudgetColors.warningLine, backgroundColor: BudgetColors.warningSurface }, warningHeader: { flexDirection: 'row', alignItems: 'center', gap: 11 }, warningCopy: { flex: 1, gap: 2 }, warningTitle: { color: BudgetColors.ink, fontFamily: Fonts.sans, fontSize: 13, fontWeight: '800' }, warningDetail: { color: BudgetColors.muted, fontFamily: Fonts.sans, fontSize: 10 }, warningAction: { color: BudgetColors.warningInk, fontFamily: Fonts.sans, fontSize: 11, fontWeight: '800' }, warningList: { marginTop: 16, borderTopWidth: 1, borderTopColor: BudgetColors.warningLine }, warningRow: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: BudgetColors.warningDivider, gap: 2 }, warningLocation: { color: BudgetColors.warningInk, fontFamily: Fonts.sans, fontSize: 9, fontWeight: '800' }, warningMessage: { color: BudgetColors.muted, fontFamily: Fonts.sans, fontSize: 11, lineHeight: 16 },
  confirmPanel: { padding: 18, borderRadius: 8, backgroundColor: BudgetColors.greenSoft, borderWidth: 1, borderColor: BudgetColors.successLine, flexDirection: 'row', alignItems: 'center', gap: 16, flexWrap: 'wrap' }, confirmCopy: { flex: 1, minWidth: 230, gap: 3 }, confirmTitle: { color: BudgetColors.ink, fontFamily: Fonts.sans, fontSize: 14, fontWeight: '800' }, confirmDetail: { color: BudgetColors.muted, fontFamily: Fonts.sans, fontSize: 11, lineHeight: 16 }, importButton: { minHeight: 44, paddingHorizontal: 16, borderRadius: 7, backgroundColor: BudgetColors.green, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, importText: { color: BudgetColors.surface, fontFamily: Fonts.sans, fontSize: 12, fontWeight: '800' },
  successPanel: { borderColor: BudgetColors.successLine }, successHeader: { flexDirection: 'row', alignItems: 'center', gap: 12 }, successIcon: { width: 46, height: 46, borderRadius: 8, backgroundColor: BudgetColors.greenSoft, alignItems: 'center', justifyContent: 'center' }, successCopy: { flex: 1, gap: 3 }, successTitle: { color: BudgetColors.ink, fontFamily: Fonts.serif, fontSize: 21, fontWeight: '700' }, successDetail: { color: BudgetColors.muted, fontFamily: Fonts.sans, fontSize: 11 },
